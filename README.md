...
To turn your markdown into ~~gold~~ DataObjects, run `dev/tasks/SilverStripe-Clippy-Task-GenerateUserGuides`.
...
## Contributors
 * Jeremy Cole (Thanks for building the bones of this with me!)
